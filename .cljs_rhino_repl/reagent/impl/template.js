...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__13971__auto__,writer__13972__auto__,opt__13973__auto__){
return cljs.core._write.call(null,writer__13972__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__16771 = o;
(G__16771[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__16773__i < G__16773__a.length) {G__16773__a[G__16773__i] = arguments[G__16773__i + 0]; ++G__16773__i;}
  args = new cljs.core.IndexedSeq(G__16773__a,0,null);
} 
...
if(cljs.core.truth_((function (){var and__13334__auto__ = !((jsprops == null));
if(and__13334__auto__){
var and__13334__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__16777 = jsprops;
(G__16777["defaultValue"] = value);

(G__16777["onChange"] = ((function (G__16777,v,value,on_change){
return (function (p1__16776_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__16776_SHARP_);
});})(G__16777,v,value,on_change))
);
...
var vec__16780 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__16780,(0),null);
var id = cljs.core.nth.call(null,vec__16780,(1),null);
var class$ = cljs.core.nth.call(null,vec__16780,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___16784 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___16784 == null)){
} else {
var key_16785 = temp__4661__auto___16784;
(jsprops["key"] = key_16785);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__16786 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__16786["name"] = c);
...
var len__14517__auto___16791 = arguments.length;
var i__14518__auto___16792 = (0);
while(true){
if((i__14518__auto___16792 < len__14517__auto___16791)){
args__14524__auto__.push((arguments[i__14518__auto___16792]));

var G__16793 = (i__14518__auto___16792 + (1));
i__14518__auto___16792 = G__16793;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__14525__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq16789){
var G__16790 = cljs.core.first.call(null,seq16789);
var seq16789__$1 = cljs.core.next.call(null,seq16789);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__16790,seq16789__$1);
});
...
break;
default:
var G__16796 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__16796;
continue;
...
var n__14293__auto___16798 = a.length;
var i_16799 = (0);
while(true){
if((i_16799 < n__14293__auto___16798)){
(a[i_16799] = reagent.impl.template.as_element.call(null,(a[i_16799])));

var G__16800 = (i_16799 + (1));
i_16799 = G__16800;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__14293__auto___16801 = a.length;
var i_16802 = (0);
while(true){
if((i_16802 < n__14293__auto___16801)){
var val_16803 = (a[i_16802]);
if((cljs.core.vector_QMARK_.call(null,val_16803)) && ((reagent.impl.template.key_from_vec.call(null,val_16803) == null))){
(o["no-key"] = true);
} else {
}

(a[i_16802] = reagent.impl.template.as_element.call(null,val_16803));
...
var ctx = ({});
var vec__16805 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__16805,(0),null);
var derefed = cljs.core.nth.call(null,vec__16805,(1),null);
...
var G__16808 = (cljs.core.count.call(null,argv) - first_child);
switch (G__16808) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__16808){
